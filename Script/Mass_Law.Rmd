...
# Experiment 1: Create control and treatment populations (Massachusetts v New Hampshire)
```{r}
...
comb_ts <- merge(comb_ts,pop, by = "yearmonth")
...
# Experiment 2: Create control and treatment populations (Massachusetts v North Carolina)
```{r}
...
acfcontrolMA1k <- acf(control_ts) # autocorrelation (i.e. a Time Series with lags of itself)
acttreatmentNC1k <- acf(treatment_ts)
# shows that the control time series is a "stationary time series"

png(here::here("Output","acfcontrolMA1k.png"))
plot(acfcontrolMA1k)

png(here::here("Output","acttreatmentNC1k.png"))
plot(acttreatmentNC1k)

pacfcontrolMA1k <- pacf(control_ts)  # partial autocorrelation (i.e. correlation of the time series with a lag of itself, with the linear dependence of all the lags between them removed.)
pacftreatmentNC1k <- pacf(treatment_ts)  # partial autocorrelation (i.e. correlation of the time series with a lag of itself, with the linear dependence of all the lags between them removed.)

png(here::here("Output","pacfcontrolMA.png"))
plot(pacfcontrolMA1k)

png(here::here("Output","pacftreatmentNH.png"))
plot(pacftreatmentNC1k)
