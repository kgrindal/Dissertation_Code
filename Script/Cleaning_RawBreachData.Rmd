...
connecticut$credit_monitoring <- stringr::str_replace_all(connecticut$credit_monitoring, 'Y|Yes', '1')
connecticut$credit_monitoring <- stringr::str_replace_all(connecticut$credit_monitoring, 'N|No', "0")
connecticut$notification <- stringr::str_replace_all(connecticut$notification, 'Y|Yes', '1')
connecticut$notification <- stringr::str_replace_all(connecticut$notification, 'N|No', '0')
connecticut$name_lost <- stringr::str_replace_all(connecticut$name_lost, 'Y|Yes', '1')
connecticut$name_lost <- stringr::str_replace_all(connecticut$name_lost, 'N|No', '0')
connecticut$address_lost <- stringr::str_replace_all(connecticut$address_lost, 'Y|Yes', '1')
connecticut$address_lost <- stringr::str_replace_all(connecticut$address_lost, 'N|No', '0')
connecticut$email_lost <- stringr::str_replace_all(connecticut$email_lost, 'Y|Yes', '1')
connecticut$email_lost <- stringr::str_replace_all(connecticut$email_lost, 'N|No', '0')
connecticut$SSN_breach <- stringr::str_replace_all(connecticut$SSN_breach, 'Y|Yes', '1')
connecticut$SSN_breach <- stringr::str_replace_all(connecticut$SSN_breach, 'N|No', '0')
connecticut$birth_lost <- stringr::str_replace_all(connecticut$birth_lost, 'Y|Yes', '1')
connecticut$birth_lost <- stringr::str_replace_all(connecticut$birth_lost, 'N|No', '0')
connecticut$track1 <- stringr::str_replace_all(connecticut$track1, 'Y|Yes', '1')
connecticut$track1 <- stringr::str_replace_all(connecticut$track1, 'N|No', '0')
connecticut$track2 <- stringr::str_replace_all(connecticut$track2, 'Y|Yes', '1')
connecticut$track2 <- stringr::str_replace_all(connecticut$track2, 'N|No', '0')
connecticut$credit_debit <- stringr::str_replace_all(connecticut$credit_debit, 'Y|Yes', '1')
connecticut$credit_debit <- stringr::str_replace_all(connecticut$credit_debit, 'N|No', '0')

massachusetts$credit_debit <- stringr::str_replace_all(massachusetts$credit_debit, 'Yes', '1')
massachusetts$credit_monitoring <- stringr::str_replace_all(massachusetts$credit_monitoring, 'Yes', '1')
massachusetts$encrypted <- stringr::str_replace_all(massachusetts$encrypted, 'Yes', '1')
massachusetts$mobile_device <- stringr::str_replace_all(massachusetts$mobile_device, 'Yes', '1')
massachusetts$SSN_breach <- stringr::str_replace_all(massachusetts$SSN_breach, 'Yes', '1')

maine2$SSN_breach <- stringr::str_replace_all(maine2$SSN_breach, 'TRUE', '1')
maine2$SSN_breach <- stringr::str_replace_all(maine2$SSN_breach, 'FALSE', '0')
maine2$drivers_license <- stringr::str_replace_all(maine2$drivers_license, 'TRUE', '1')
maine2$drivers_license <- stringr::str_replace_all(maine2$drivers_license, 'FALSE', '0')
...
AllState[,"date_of_breach"]<-lubridate::mdy(AllState[,"date_of_breach"]) # 1315 failed to parse
AllState[,"breach_end"]<-lubridate::mdy(AllState[,"breach_end"]) # 106 failed to parse
AllState[,"discover_date"]<-lubridate::mdy(AllState[,"discover_date"]) # 815 failed to parse
AllState[,"reported_date"]<-lubridate::mdy(AllState[,"reported_date"]) # 267 failed to parse
