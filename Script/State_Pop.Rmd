...
Populations <- na.approx(Populations, rule = 2)

Populations <- as.data.frame(cbind(MonthsList[-1],Populations))

Populations[2:ncol(Populations)] <- sapply(Populations[2:ncol(Populations)],as.numeric)

Populations <- Populations %>% 
  mutate_if(is.numeric, round, 2)

as.data.frame(Populations)
