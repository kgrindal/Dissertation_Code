...
# setwd<-("C:/Users/karl_000/Documents/SpiderOak Hive/Dissertation/Dissertation_Code/Data/Other_data/")
# AllStateClean <- read.table(file = "AllStateClean.txt", sep = ";")

AllSourceClean <- read.table(file = "Data/Other_data/AllSourceClean.txt", header=TRUE, sep = ";")
