...
write.csv(HITECH,here("Data","Other_data","HITECH.csv"))
...
HITECH <- read.csv(here("Data","Other_data","HITECH.csv"))
DUNS <- read.csv(here("Data","Other_data","DUNS_HITECH.csv"))
                 
NAICS <- merge(HITECH, DUNS, by="clean_name", all=TRUE)

NAICS$DUNS_2 <- substr(NAICS$Primary.NAICS.Code, start=1, stop=2)
colSums(!is.na(NAICS)) # 1788 
colSums(is.na(NAICS)) # 215
1741/1956 # = 89%

write.csv(NAICS, here("Data","Other_data","NAICS_Clean.csv"))
